...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2021 at 08:40 PM
...
(0, 'james', '9999999', '010', 'Ang Mo Kio', 'ttttt', '3', '2021-06-03 01:10:48');
...
ALTER TABLE `patrolcar`
  ADD PRIMARY KEY (`patrolcar_id`),
  ADD UNIQUE KEY `patrolcar_status_id` (`patrolcar_status_id`),
...
ALTER TABLE `dispatch`
  ...
  ADD CONSTRAINT `dispatch_ibfk_2` FOREIGN KEY (`patrolcar_id`) REFERENCES `patrolcar_status` (`patrolcar_status_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `patrolcar_status`
  ADD CONSTRAINT `patrolcar_status_ibfk_1` FOREIGN KEY (`patrolcar_status_id`) REFERENCES `patrolcar` (`patrolcar_status_id`);
COMMIT;
