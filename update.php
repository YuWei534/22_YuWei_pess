...
if (isset($_POST["btnUpdate"])){
	...
	if ($_POST["patrolCarStatus"] == '4'){
	  ...
	  // last but not least, update incident table to completed (3) all patrol car attended to it are FREE
...
<body>
<!---END OF STEP 11 IN THE PROJECT 7 PROGRAM AND DEPLOY_V1.DOCX---->
<!--START OF STEP 7 IN THE PROJECT 7 PROGRAM AND DEPLOY_V1.DOCX---->
                   <!-- PART 1 -->
...
//START OF STEP 9 IN THE PROJECT 7 PROGRAM AND DEPLOY_V1.DOCX---->
// Part 2 /////////////////////////////////////////////
...
<form name="form2" method="post" 
    ...
    <tr>	   
	    ...
	    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit"
	      name="btnUpdate" id="btnUpdate" value="Update">
	    </td>
   </tr>
</table>
</form>
