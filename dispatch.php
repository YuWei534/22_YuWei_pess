...
<!--START OF STEP 12 IN THE PROJECT 6 PROGRAM AND DEPLOY_V1.DOCX---->
                   <!-- PART 3 -->
<?php // validate if request comes from logcall.php or post back
if (!isset($_POST["btnProcessCall"]) && !isset($_POST["btnDispatch"]))
	header("Location: logcall.php");
?>
<!--END OF STEP 12 IN THE PROJECT 6 PROGRAM AND DEPLOY_V1.DOCX---->
...
<body>
<!--END OF STEP 10 IN THE PROJECT 6 PROGRAM AND DEPLOY_V1.DOCX---->
<!--Start of Step 6 in the Project 6 Program and deploy_v1.docx---->
...
<table class="ContentStyle">
   ...
   <tr>
	  ...
	  <td><textarea name="incidentDesc" cols="45" 
		  ...
		  <input name="incidentDesc" type="hidden" id="incidentType"
	      value="<?php echo $_POST['incidentDesc'] ?>"></td>
   </tr>
</table>
<br><br>
<!--End of step 6 in the Project 6 Program and deploy_v1.docx---->
<!--Start of step 8.1 in the Project 6_Program and deploy_v1.docx---->
<?php
...
<!--Start of step 8.2 in the project 6_Program and deploy_v1.docx---->
